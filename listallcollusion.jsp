...
<div class="main">
  ...
  <div class="content">
    ...
    <td width="109"><div align="center"><strong><span class="style3">Changed Feedback</span></strong></div></td>
    <td width="154"><div align="center"><strong><span class="style3">Feedback ID</span></strong></div></td>
	...
	<td width="124"><div align="center"><strong><span class="style3">Recovery </span></strong></div></td>
...
<%
      	...
      	try 
	{
           ...
           String query="select * from Attackers1   "; 
...
%>
  ...
  <tr>
    ...
    <td><div align="center"><font color="red"><%=s7%></div></td>
     <td><div align="center"><a href="Recovery.jsp?uid=<%=i%>"> Recover Feedback &nbsp;</a></div></td>
  </tr>
