...
<div class="main">
  ...
  <div class="content">
          ...
          <div class="mainbar">
            ...
            <p>&nbsp;</p>
              <h2>View Cloud Files </h2>
               <br />
              <form name="form1" method="post" action="reqfile1.jsp">
                <table width="371" border="0" align="center">
                    <tr bgcolor="red">
                        <td><strong><font color="yellow">Select the Cloud Server</strong></td>
      <td><label>
        <select name="t1">
    ...
    <tr bgcolor="red">
      <td><strong><font color="yellow">Enter the File Name </strong></td>
      <td><input type="text" name="t2" /></td>
    </tr>
                    <tr bgcolor="red">
      <td><strong><font color="yellow">Enter the Owner Name </strong></td>
      <td><input type="text" name="t3" /></td>
    </tr>
                    <tr bgcolor="red">
      <td><strong><font color="yellow">Enter the SK </strong></td>
