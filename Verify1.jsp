      ...
      <div class="mainbar">
        <div class="article">
          ...
          <div class="mainbar">
            <div class="article">
            <p>&nbsp;</p>
              <h2>Verify the File in Cloud</h2>
              			  <br />
              <%
		...
		try
		{
			...
			if(rs.next())
			{
				...
				String query1="select * from backup where oname='"+uname+"' and cname='"+cname+"' and fname='"+fname+"' and mac='"+mac+"' "; 
		           
		           ResultSet rs1=st.executeQuery(query1);
				
				if(rs1.next())
				{
					out.println("FILE IS SAFE IN CLOUD");
					
					
					%><p><a href="Verify.jsp">Back</a></p>
				...
				{
					out.println("FILE IS NOT SAFE IN CLOUD");
