...
<%
  ...
  <table width="548" border="1" align="center">
    <tr >
        <td bgcolor="red"><span class="style10"> Cloud Name:- </span></td>
      <td><input type="text" name="t1" value="<%= cname %>"  readonly></td>
    </tr>
    <tr>
      <td bgcolor="red"><span class="style10"> File Name:- </span></td>
      <td><input type="text" name="t2" value="<%= fname %>" readonly></td>
    </tr>
     <tr>
      <td bgcolor="red"><span class="style10"> Owner Name:- </span></td>
      <td><input type="text" name="t3" value="<%= oname %>" readonly></td>
    </tr>
    <tr>
      <td bgcolor="red"><span class="style10">Change the File Content:-</span></td>
