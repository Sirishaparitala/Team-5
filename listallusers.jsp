...
<div class="main">
  ...
  <div class="content">
    ...
    <td width="124"><div align="center"><span class="style3">User Type </span></div></td>
	<td width="124"><div align="center"><span class="style3">Service Type </span></div></td>
	<td width="124"><div align="center"><span class="style3">Cloud </span></div></td>
...
<%
      	...
      	try 
	{
         String cname=(String)application.getAttribute("cname");
           String query="select * from user where cname='"+cname+"'  "; 
