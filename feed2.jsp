...
<%
	...
	int i=0,j=0,k=0;
      	...
      	try 
	{
      		 int mid=Integer.parseInt(request.getParameter("t1"));      
           String cname=request.getParameter("t2");      
           String feed=request.getParameter("t3"); 
           ...
           st.executeUpdate("update feedback set feedback='"+feed+"' where id="+mid+" ");
	  ...
	  InetAddress localhost = InetAddress.getLocalHost(); 
        System.out.println("System IP Address : " + 
           ...
           String ip_h = (localhost.getHostAddress()).trim(); 
			...
			st.executeUpdate(" insert into Attackers1 values ('"+uname+"','"+cname+"','"+feed+"',"+mid+",'"+ip_h+"','"+host_h+"','"+dt+"') ");
