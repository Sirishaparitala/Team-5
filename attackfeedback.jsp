      ...
      <div class="mainbar">
        <div class="article">
          ...
          <div class="mainbar">
            <div class="article">
            <p>&nbsp;</p>
              <h2 class="style2">Attack Feedback</h2>
               <br />
              <form name="form1" method="post" action="attackfeedback1.jsp">
                <table width="371" border="0" align="center">
    <tr>
      <td><span class="style2"><strong>Select the Cloud Server</strong></span></td>
      <td><label>
        <select name="t1">
      ...
      <div class="sidebar">
        <div class="gadget">
          ...
          <div class="clr style2"></div>
             <ul class="sb_menu">
             <li class="style2"><a href="viewcloudrepu0.jsp">Find Reputation</a></li>
            <li class="style2"><a href="viewcloudtrust0.jsp">Find Trust Worthy</a></li>
            <li class="style2"><a href="viewcloudcost0.jsp">Find Cost & Memory</a></li>
            <li class="active"><span class="style2"><a href="viewcloudfiles0.jsp">View Cloud Files</a></span></li>
          </ul>
        </div>
      </div>
      <div class="clr"></div>
