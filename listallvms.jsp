      ...
      <div class="mainbar">
        <div class="article">
          ...
          <div class="mainbar">
            <div class="article">
            <p>&nbsp;</p>
              <h2>View Cloud VMs</h2>
              			  <br />
              <table width="924" border="1" align="center">
                  <tr bgcolor="yellow">
    <td width="241"><div align="center" class="style1"><span class="style3">Owner </span></div></td>
    <td width="168"><div align="center" class="style1"><span class="style3">Cloud </span></div></td>
    <td width="109"><div align="center" class="style1"><span class="style3">Memory</span></div></td>
    <td width="154"><div align="center" class="style1"><span class="style3">Cost</span></div></td>
    <td width="102"><div align="center" class="style1"><span class="style3">Bandwidth</span></div></td>
    <td width="124"><div align="center" class="style1"><span class="style3">Date & Time </span></div></td>
  </tr>
...
<%
      	...
      	try 
	{
         String cname=(String)application.getAttribute("cname");
           String query="select * from vm where cname='"+cname+"'  "; 
